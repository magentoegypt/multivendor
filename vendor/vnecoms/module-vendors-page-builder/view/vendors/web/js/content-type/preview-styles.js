/*eslint-disable */
/* jscs:disable */
define(["knockout", "Magento_PageBuilder/js/events", "Vnecoms_VendorsPageBuilder/js/content-type/style-registry"], function (_knockout, _events, _styleRegistry) {
  /**
  ...
  function () {
    ...
    function PreviewStyles(stageId) {
      ...
      this.template = "Vnecoms_VendorsPageBuilder/content-type/preview-styles";
