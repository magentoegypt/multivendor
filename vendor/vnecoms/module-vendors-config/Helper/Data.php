...
class Data extends AbstractHelper
{
     ...
     * @param \Magento\Config\Model\Config\StructureFactory $configStructure
    ...
    public function __construct(
        ...
        \Magento\Config\Model\Config\StructureFactory $configStructure,
    ...
    public function saveConfig($vendorId, $sectionId, $groups, $storeId = 0)
    {
        ...
        try {
            $this->eventManager->dispatch(
                "vendor_config_before_change_section_{$sectionId}",
                ['vendor_id' => $vendorId, "groups" => $groups]
            );
    ...
    protected function _processGroup(
        ...
        $group = $this->configStructure->create()->getElement($groupPath);
        ...
        if (isset($groupData['fields'])) {
            ...
            foreach ($groupData['fields'] as $fieldId => $fieldData) {
                ...
                /** @var $field \Magento\Config\Model\Config\Structure\Element\Field */
                $field = $this->configStructure->create()->getElement($groupPath . '/' . $originalFieldId);
