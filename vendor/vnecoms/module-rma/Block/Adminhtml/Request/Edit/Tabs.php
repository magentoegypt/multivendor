...
class Tabs extends \Magento\Backend\Block\Widget\Tabs
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addTab('adminhtml_rma_edit_tab_message', [
            'label'     => __('RMA Comments'),
            'title'     => __('RMA Comments'),
            'content'   => $this->getLayout()->createBlock('Vnecoms\RMA\Block\Adminhtml\Request\Edit\Tabs\Message')
                ->toHtml(),
            'active'    => true
        ]);

        $this->addTab('adminhtml_request_edit_tab_item', [
            'label'     => __('RMA Items'),
            'title'     => __('RMA Items'),
        ...
        $this->addTab('adminhtml_request_edit_tab_address', [
        ...
        $this->addTab('adminhtml_request_edit_tab_status', [
        ...
        $this->addTab('adminhtml_request_edit_tab_history', [
            'label'     => __('Other RMA'),
            'title'     => __('Other RMA'),
