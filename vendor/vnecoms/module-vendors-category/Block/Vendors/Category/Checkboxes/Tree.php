...
namespace Vnecoms\VendorsCategory\Block\Vendors\Category\Checkboxes;

use Magento\Framework\Data\Tree\Node;

class Tree extends \Vnecoms\VendorsCategory\Block\Vendors\Category\Tree
{
    /**
     * @var int[]
     */
    ...
    {
        $this->setTemplate('category/checkboxes/tree.phtml');
    }
