 ...
 */
namespace Vnecoms\VendorsProductImportExport\Observer;

use Magento\Framework\Event\ObserverInterface;
use Magento\Catalog\Model\ResourceModel\Product\CollectionFactory;

class ProductImportExportPredispatch implements ObserverInterface
{
    /**
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        if ($this->moduleManager->isOutputEnabled('Vnecoms_VendorsGroup')) {
            ...
            if (!$groupHelper->canUseProductImportExport($groupId)) {
