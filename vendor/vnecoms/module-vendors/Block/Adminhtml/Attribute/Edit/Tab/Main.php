...
class Main extends AbstractMain
{
    ...
    protected function _prepareForm()
    {
        ...
        $helperSource = ObjectManager::getInstance()->create('Vnecoms\Vendors\Helper\Data');

        $attibutesIgnoreType = $helperSource->getIgnoreAttributeType();

        foreach ($fieldTypes as $key => &$type) {
            if (in_array($type['value'], $attibutesIgnoreType)) {
