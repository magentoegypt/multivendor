 ...
 */
class Profile extends \Magento\Framework\View\Element\Template implements
    \Magento\Framework\DataObject\IdentityInterface
{
    ...
    {
        $vendorId = $this->getVendor() ? $this->getVendor()->getId() : null;
        return [\Vnecoms\Vendors\Model\Vendor::CACHE_TAG . '_' . $vendorId];
    }
     ...
     * @return boolean
     */
    public function canShowVendorJoinDate()
    {
        return $this->_vendorHelper->showVendorJoinDate();
    }
     ...
     * @return boolean
     */
    public function canShowVendorSalesCount()
    {
        return $this->_vendorHelper->showVendorSalesCount();
    }
    ...
    public function getAddress()
    {
        ...
        $address = $this->_filter->setVariables($variables)->filter($template);
