...
define(["mage/translate", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type/column/resize"], function (_translate, _config, _resize) {
  /**
