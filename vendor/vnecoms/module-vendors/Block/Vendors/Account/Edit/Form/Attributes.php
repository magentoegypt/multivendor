...
class Attributes extends Generic
{
    ...
    */
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('texteditor', 'Vnecoms\Vendors\Block\Vendors\Widget\Form\Element\Editor');
        $fieldset->addType('datetime', 'Vnecoms\Vendors\Block\Adminhtml\Form\Element\DateTime');
