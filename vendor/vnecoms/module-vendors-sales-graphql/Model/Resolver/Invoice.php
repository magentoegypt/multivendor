...
use Vnecoms\VendorsSalesGraphQl\Model\Invoice\GetListInvoice;
...
class Invoice implements ResolverInterface
{
     ...
     * @var GetListInvoice
     */
    private $getListInvoice;

    /**
     * Invoice constructor.
     * @param GetListInvoice $getListInvoice
     */
    public function __construct(
        GetListInvoice $getListInvoice
    ) {
        $this->getListInvoice = $getListInvoice;
    }
    ...
    public function resolve(
        ...
        $searchResult = $this->getListInvoice->execute($args, $info, $context);
