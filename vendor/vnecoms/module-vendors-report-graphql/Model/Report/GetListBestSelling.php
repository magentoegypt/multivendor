...
use Vnecoms\VendorsApi\Api\Data\Report\BestsellingInterface;
/**
 * Get vendor
 */
class GetListBestSelling
{
    /**
    ...
    public function execute($args, ResolveInfo $info, ContextInterface $context)
    {
        ...
        $searchResults = $this->reportRepository->getBestSelling(
            $currentUserId,
            $args["limit"]
        );
        ...
        foreach ($searchResults->getItems() as $report) {
            $reportData = $this->dataObjectConverter->toFlatArray($report, [], BestsellingInterface::class);
