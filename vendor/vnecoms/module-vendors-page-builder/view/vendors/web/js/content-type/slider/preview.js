...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "slick", "underscore", "Vnecoms_VendorsPageBuilder/js/binding/focus", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type-menu/hide-show-option", "Vnecoms_VendorsPageBuilder/js/content-type-menu/option", "Vnecoms_VendorsPageBuilder/js/utils/delay-until", "Vnecoms_VendorsPageBuilder/js/utils/promise-deferred", "Vnecoms_VendorsPageBuilder/js/content-type/preview-collection"], function (_jquery, _knockout, _translate, _events, _slick, _underscore, _focus, _config, _contentTypeFactory, _hideShowOption, _option, _delayUntil, _promiseDeferred, _previewCollection) {
  /**
