...
import alertDialog from "Vnecoms_VendorsPageBuilder/js/modal/confirm-alert";
import templateManagerSave from "Vnecoms_VendorsPageBuilder/js/modal/template-manager-save";
import promptContentTmpl from "text!Vnecoms_VendorsPageBuilder/template/modal/template-manager/save-content-modal.html";
