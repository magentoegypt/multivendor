...
define(["jquery", "mageUtils", "underscore", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type/appearance-config", "Vnecoms_VendorsPageBuilder/js/converter/converter-pool-factory", "Vnecoms_VendorsPageBuilder/js/mass-converter/converter-pool-factory", "Vnecoms_VendorsPageBuilder/js/property/property-reader-pool-factory"], function (_jquery, _mageUtils, _underscore, _config, _appearanceConfig, _converterPoolFactory, _converterPoolFactory2, _propertyReaderPoolFactory) {
  /**
