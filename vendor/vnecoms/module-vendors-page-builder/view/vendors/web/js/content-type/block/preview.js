...
define(["jquery", "knockout", "mage/translate", "Vnecoms_VendorsPageBuilder/js/widget-initializer", "mageUtils", "underscore", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-menu/hide-show-option", "Vnecoms_VendorsPageBuilder/js/content-type/style-registry", "Vnecoms_VendorsPageBuilder/js/utils/object", "Vnecoms_VendorsPageBuilder/js/content-type/preview"], function (_jquery, _knockout, _translate, _widgetInitializer, _mageUtils, _underscore, _config, _hideShowOption, _styleRegistry, _object, _preview) {
  /**
