...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "Magento_Ui/js/lib/knockout/template/loader", "Magento_Ui/js/modal/alert", "mageUtils", "underscore", "Vnecoms_VendorsPageBuilder/js/acl", "Vnecoms_VendorsPageBuilder/js/binding/style", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/panel", "Vnecoms_VendorsPageBuilder/js/stage", "Vnecoms_VendorsPageBuilder/js/template-manager"], function (_jquery, _knockout, _translate, _events, _loader, _alert, _mageUtils, _underscore, _acl, _style, _config, _contentTypeFactory, _panel, _stage, _templateManager) {
  /**
  ...
  var PageBuilder = /*#__PURE__*/function () {
    ...
    function PageBuilder(config, initialValue) {
      ...
      this.template = "Vnecoms_VendorsPageBuilder/page-builder";
    ...
    _createClass(PageBuilder, [{
      ...
      get: function get() {
        return "Vnecoms_VendorsPageBuilder/viewport/switcher";
      }
    }]);
