...
class AbstractWidget extends \Magento\Framework\View\Element\Template
{
    ...
    public function setVendorAttribute(\Vnecoms\Vendors\Model\Attribute $attribute)
    {
        ...
        if ($frontendInput == 'select' || $frontendInput == 'boolean') {
            ...
            $this->setTemplate('account/create/fieldset/textarea.phtml');
        }elseif ($frontendInput == 'texteditor') {
            $this->setTemplate('account/create/fieldset/texteditor.phtml');
        } elseif ($frontendInput == 'hidden') {
            $this->setTemplate('account/create/fieldset/hidden.phtml');
        } elseif ($frontendInput == 'date' || $frontendInput == 'datetime') {
            $this->setTemplate('account/create/fieldset/date.phtml');
        }
        return $this;
    }
