...
namespace Vnecoms\VendorsPageBuilder\Plugin\Catalog\Ui\DataProvider\Product\Form\Modifier;

use Magento\Catalog\Api\Data\ProductAttributeInterface;
use Vnecoms\VendorsProduct\Ui\DataProvider\Product\Form\Modifier\Eav as EavModifier;
        ...
        if ($this->config->isContentPreviewEnabled() && $attribute->getData('is_pagebuilder_enabled')) {
            $containerMeta = $this->arrayManager->merge(
                ...
                [
                    ...
                    'template' => 'Vnecoms_VendorsPageBuilder/form/components/group/group'
                ]
            );
        }
