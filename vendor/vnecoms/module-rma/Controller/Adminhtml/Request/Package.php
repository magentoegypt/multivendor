...
class Package extends Action
{
    ...
    public function execute()
    {
        ...
        $status = $this->status->create()->load(\Vnecoms\RMA\Model\Request::STATUS_RECEIVED, "code");
        if ($id) {
            ...
            try {
                ...
                $this->messageManager->addSuccess(__('Rma was successfully changed status to package received'));
                return $resultRedirect->setPath('*/*/view', ['request_id' => $id, '_current' => true]);
