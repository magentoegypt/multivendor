...
define(["jarallax", "jarallaxVideo", "jquery", "knockout", "Magento_PageBuilder/js/events", "Vnecoms_VendorsPageBuilder/js/resource/resize-observer/ResizeObserver", "underscore", "vimeoWrapper", "Vnecoms_VendorsPageBuilder/js/content-type-menu/hide-show-option", "Vnecoms_VendorsPageBuilder/js/content-type/preview-collection"], function (_jarallax, _jarallaxVideo, _jquery, _knockout, _events, _ResizeObserver, _underscore, _vimeoWrapper, _hideShowOption, _previewCollection) {
  /**
