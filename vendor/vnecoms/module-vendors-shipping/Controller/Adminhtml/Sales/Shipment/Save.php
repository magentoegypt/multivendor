...
class Save extends \Magento\Backend\App\Action
{
     ...
     * @param \Vnecoms\VendorsShipping\Model\Shipping\LabelGenerator $labelGenerator
     * @param \Magento\Sales\Model\Order\Email\Sender\ShipmentSender $shipmentSender
     */
    public function __construct(
        \Magento\Backend\App\Action\Context $context,
        \Vnecoms\VendorsSales\Controller\Adminhtml\Sales\Shipment\ShipmentLoader $shipmentLoader,
        \Vnecoms\VendorsShipping\Model\Shipping\LabelGenerator $labelGenerator,
    ...
    public function execute()
    {
        ...
        try {
			...
			if(is_array($validationResult) && sizeof($validationResult)){
                ...
                return;
			}elseif (!is_array($validationResult) && $validationResult->hasMessages()) {
                $this->messageManager->addError(
