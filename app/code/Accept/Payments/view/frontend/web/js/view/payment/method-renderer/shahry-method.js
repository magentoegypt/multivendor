define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Accept_Payments/payment/shahry',
                success: false,
                iframe_url: null,
                owner: null,
                cards: null,
            ...
            afterPlaceOrder: function (data, event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: url.build('accept/methods/shahrymethod'),
                    data: data.toString(),
                    processData: false,
            ...
            renderErrors: function (data) {
                ...
                $('#shahry-container').show(250, function(){
                    $('#shahry-errors').show(250, function(){
                        $('#shahry-errors .errors').show().html(data.detail);
                    });
                });
            },
            getData: function () {
