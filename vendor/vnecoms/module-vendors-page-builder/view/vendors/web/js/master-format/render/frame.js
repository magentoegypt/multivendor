/*eslint-disable */
/* jscs:disable */
define(["csso", "jquery", "knockout", "Magento_Ui/js/lib/knockout/template/engine", "mageUtils", "underscore", "Vnecoms_VendorsPageBuilder/js/binding/master-style", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type/style-registry", "Vnecoms_VendorsPageBuilder/js/utils/directives", "Vnecoms_VendorsPageBuilder/js/master-format/filter-html"], function (_csso, _jquery, _knockout, _engine, _mageUtils, _underscore, _masterStyle, _config, _contentTypeFactory, _styleRegistry, _directives, _filterHtml) {
