/*eslint-disable */
/* jscs:disable */
define(["mage/translate", "Magento_PageBuilder/js/events", "Magento_Ui/js/modal/alert", "underscore", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-collection", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type/appearance-config", "Vnecoms_VendorsPageBuilder/js/content-type/style-registry", "Vnecoms_VendorsPageBuilder/js/master-format/validator", "Vnecoms_VendorsPageBuilder/js/utils/directives", "Vnecoms_VendorsPageBuilder/js/utils/loader", "Vnecoms_VendorsPageBuilder/js/utils/object"], function (_translate, _events, _alert, _, _config, _contentTypeCollection, _contentTypeFactory, _appearanceConfig, _styleRegistry, _validator, _directives, _loader, _object) {
