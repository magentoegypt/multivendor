								...
								<div class="line content-panel empty-block">
									<div class="add-new-block col-des-12">';
										...
										if($this->getRequest()->getParam('page_id')){
											...
											$html .= '<button class="action btn btn-default btn-addnewblock" type="button" onclick="openPopup(\''.$url.'\')" data-page-id="'.$pageId .'" data-block-name="'.$name.'-0"><em class="fa fa-plus-circle"></em>&nbsp;'.__('Add New Block').'</button>';
