var config = {
    "paths": {
        ...
        "Magento_Bundle/js/bundle-product": "Vnecoms_VendorsProductBundle/js/bundle-product",
        "Magento_Bundle/js/bundle-type-handler": "Vnecoms_VendorsProductBundle/js/components/bundle-type-handler",
