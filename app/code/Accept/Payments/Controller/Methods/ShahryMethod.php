...
/**
 * Shahry Payment Method
 */
use Accept\Payments\Helper\Accepting;
use Magento\Framework\App\CsrfAwareActionInterface;
use Magento\Framework\App\RequestInterface;
use Magento\Framework\App\Request\InvalidRequestException;
class ShahryMethod extends \Magento\Framework\App\Action\Action implements CsrfAwareActionInterface
{
    public function __construct(
        \Magento\Framework\App\Action\Context $context,
        \Magento\Sales\Model\Order $order,
        \Magento\Framework\App\ResourceConnection $resource,
        \Accept\Payments\Model\Shahry $shahry
    )
    {
    ...
    public function execute()
    {
        ...
        try{
            ...
            if($order){
                ...
                $iframe_id = $this->shahry->getConfigData('iframe_id');

                // config to be sent to the Accepting helper.
                $config = [
                    "api_key" => $this->shahry->getConfigData('api_key'),
                    "integration_id" => $this->shahry->getConfigData('integration_id'),
