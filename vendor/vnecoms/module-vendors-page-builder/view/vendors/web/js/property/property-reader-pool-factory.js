...
define(["Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/utils/loader", "Vnecoms_VendorsPageBuilder/js/property/property-reader-pool"], function (_config, _loader, _propertyReaderPool) {
  /**
