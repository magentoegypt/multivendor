...
namespace Vnecoms\VendorsSearch\Helper;
...
{
   // const QUERY_VAR_NAME = 'vendor.q';

    const XML_PATH_MIN_QUERY_LENGTH = 'vendors/search_by_vendor/min_query_length';

    const XML_PATH_MAX_QUERY_LENGTH = 'vendors/search_by_vendor/max_query_length';
    /**
     * Note messages.
     *
     * @var array
    ...
    {
        return $this->scopeConfig->getValue('vendors/search_by_vendor/enabled');
    }
    ...
    public function getResultUrl($query = null)
    {
        ...
        return $this->vendorPageHelper->getUrl(
            $this->getVendor(),
            'searchresult',
