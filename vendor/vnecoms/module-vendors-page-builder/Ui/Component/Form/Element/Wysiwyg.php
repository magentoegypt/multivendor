...
namespace Vnecoms\VendorsPageBuilder\Ui\Component\Form\Element;
...
use Vnecoms\VendorsPageBuilder\Model\Config as PageBuilderConfig;
use Vnecoms\VendorsPageBuilder\Model\State as PageBuilderState;
use Vnecoms\VendorsPageBuilder\Model\Stage\Config as Config;
...
class Wysiwyg extends \Magento\Ui\Component\Form\Element\Wysiwyg
{
    ...
    public function __construct(
        ...
        if (!$pageBuilderState->isPageBuilderInUse($isEnablePageBuilder)) {
            ...
            $data['config']['component'] = 'Vnecoms_VendorsPageBuilder/js/form/element/wysiwyg';

            // Override the templates to include our KnockoutJS code
            $data['config']['template'] = 'ui/form/field';
            $data['config']['elementTmpl'] = 'Vnecoms_VendorsPageBuilder/form/element/wysiwyg';
