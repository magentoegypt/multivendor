...
namespace Vnecoms\VendorsMedia\Block;
...
class Media extends \Magento\Framework\View\Element\Template
{
     ...
     * @var string
     */
    protected $_template = 'Vnecoms_VendorsMedia::media.phtml';
    ...
    /**
     * @var \Vnecoms\VendorsMedia\Helper\Data
     */
    protected $helper;
    ...
    public function __construct(
        ...
        \Vnecoms\VendorsMedia\Helper\Data $helper,
    ...
    public function getJsLayout()
    {
        ...
        $this->jsLayout['components']['media']['delete_url'] = $this->getUrl('cmedia/image/delete');
    ...
    {
        return $this->getUrl('cmedia/image/upload');
    }
}
