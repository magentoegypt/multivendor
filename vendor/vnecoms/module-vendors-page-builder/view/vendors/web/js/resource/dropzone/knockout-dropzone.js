...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['knockout', 'jquery', 'Vnecoms_VendorsPageBuilder/js/resource/dropzone/dropzone', 'mage/translate'], factory);
    } else if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        // CommonJS module
        var ko = require('knockout'),
            jQuery = require('jquery'),
            Dropzone = require('Vnecoms_VendorsPageBuilder/js/resource/dropzone/dropzone'),
