 ...
 */
class Export extends \Magento\Backend\Block\Widget implements \Vnecoms\Vendors\Block\Vendors\Widget\Grid\ExportInterface
{
    /**
     * Grid export types
     *
     ...
     * @var string
     */
    protected $_template = "Vnecoms_Vendors::widget/grid/export.phtml";
