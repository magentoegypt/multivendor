...
define(["consoleLogger", "knockout", "underscore", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type/appearance-config", "Vnecoms_VendorsPageBuilder/js/content-type/observable-updater/attributes", "Vnecoms_VendorsPageBuilder/js/content-type/observable-updater/css", "Vnecoms_VendorsPageBuilder/js/content-type/observable-updater/html", "Vnecoms_VendorsPageBuilder/js/content-type/observable-updater/style"], function (_consoleLogger, _knockout, _underscore, _config, _appearanceConfig, _attributes, _css, _html, _style) {
  /**
