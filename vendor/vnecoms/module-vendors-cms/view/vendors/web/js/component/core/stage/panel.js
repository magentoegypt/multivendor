...
define(['jquery', 'vendorscms/renderer', 'vendorscms/cms-config', 'vendorscms/hook', 'vendorscms/dragdrop', 'jquery/bluefoot-accordion'], function (jQuery, Render, InitConfig, Hook, DragDropClass) {
