...
define(["jarallax", "jarallaxVideo", "jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "mageUtils", "underscore", "vimeoWrapper", "Vnecoms_VendorsPageBuilder/js/content-type-menu/conditional-remove-option", "Vnecoms_VendorsPageBuilder/js/uploader", "Vnecoms_VendorsPageBuilder/js/utils/delay-until", "Vnecoms_VendorsPageBuilder/js/utils/editor", "Vnecoms_VendorsPageBuilder/js/utils/nesting-link-dialog", "Vnecoms_VendorsPageBuilder/js/utils/nesting-widget-dialog", "Vnecoms_VendorsPageBuilder/js/wysiwyg/factory", "Vnecoms_VendorsPageBuilder/js/content-type/preview"], function (_jarallax, _jarallaxVideo, _jquery, _knockout, _translate, _events, _mageUtils, _underscore, _vimeoWrapper, _conditionalRemoveOption, _uploader, _delayUntil, _editor, _nestingLinkDialog, _nestingWidgetDialog, _factory, _preview) {
  /**
