...
class Confirmation extends AbstractRenderer
{
    ...
    public function render($layout)
    {
        ...
        return $block
            ...
            ->setProduct($this->getProductByAttribute())
    ...
    private function getProductByAttribute()
    {
        $attribute = [];
        $attribute = $this->request->getParam('super_attribute');
        
        if ($attribute) { 

        $product = $this->getProduct();
        if ($product->getTypeId() == \Magento\ConfigurableProduct\Model\Product\Type\Configurable::TYPE_CODE) {
            $simple_product = $this->configurableproduct->getProductByAttributes($attribute, $product);
