    ...
    public function process($jsLayout)
    {
        ...
        foreach ($configuration as $paymentGroup => $groupConfig) {
            if (isset($groupConfig['component']) AND $groupConfig['component'] === 'Magento_Checkout/js/view/billing-address') {
                ...
                $telephoneData =   $jsLayout['components']['checkout']['children']['steps']['children']['billing-step']['children']
                ['payment']['children']['payments-list']['children'][$paymentGroup]['children']['form-fields']['children']['telephone']['config'];
                $telephoneData['elementTmpl'] = 'Vnecoms_Sms/checkout/mobile';
                $telephoneData['initialCountry'] = strtolower($this->helper->getInitialCountry());
                $telephoneData['geoIpUrl'] = $this->helper->getGeoIpDatabase()?$this->urlBuilder->getUrl('vsms/geoip'):'https://ipinfo.io';
                $telephoneData['allowDropdown'] = $this->helper->getAllowCountryDropdown();
                ...
                ['payment']['children']['payments-list']['children'][$paymentGroup]['children']['form-fields']['children']['telephone']['config'] = $telephoneData;
            }
        }
