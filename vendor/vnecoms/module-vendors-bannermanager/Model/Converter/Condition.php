...
namespace Vnecoms\BannerManager\Model\Converter;

use Vnecoms\BannerManager\Api\Data\ConditionInterfaceFactory;
use Vnecoms\BannerManager\Api\Data\ConditionInterface;

/**
 * Class Condition
 *
 * @package Vnecoms\BannerManager\Model\Converter
 */
class Condition
{
    /**
     ...
     *
     * @param array $input
     * @return \Vnecoms\BannerManager\Api\Data\ConditionInterface
     * @SuppressWarnings(PHPMD.CyclomaticComplexity)
     */
    public function arrayToDataModel(array $input)
    {
        /** @var \Vnecoms\BannerManager\Model\Data\Condition $conditionDataModel */
