...
class Data extends AbstractHelper
{
    ...
    const XML_PATH_SHOW_VENDOR_SALES_COUNT = 'vendors/profile/show_sales_count';
    const XML_PATH_SHOW_VENDOR_JOIN_DATE = 'vendors/profile/show_join_date';
     ...
     * @param array $ignoreAttributeType
     */
     ...
     * @return multitype:
     */
    public function getIgnoreAttributeType(){
        return $this->ignoreAttributeType;
    }
    ...
    public function moduleEnabled(){
        ...
        return $this->scopeConfig->getValue(self::XML_PATH_EXTENSION_ENABLE, $storeScope);
    }
    ...
    public function getPanelType(){
        $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITES;
        return $this->scopeConfig->getValue(self::XML_PATH_VENDOR_PANEL_TYPE, $storeScope);
    }
    ...
    public function getFooterText(){
        $storeScope = \Magento\Store\Model\ScopeInterface::SCOPE_STORE;
        return $this->scopeConfig->getValue(self::XML_PATH_VENDOR_FOOTER_TEXT, $storeScope);
    }
     ...
     * @return int
     */
    public function showVendorSalesCount(){
        return $this->scopeConfig->getValue(self::XML_PATH_SHOW_VENDOR_SALES_COUNT);
    }
     ...
     * @return int
     */
    public function showVendorJoinDate(){
        return $this->scopeConfig->getValue(self::XML_PATH_SHOW_VENDOR_JOIN_DATE);
    }
