...
var config = {
    map: {
        '*': {
            ...
            "Magento_Catalog/template/form/field.html":'Vnecoms_VendorsProduct/template/form/field.html',
        }
    },
    "shim": {
    ...
    "paths": {
        ...
        "Magento_Catalog/js/components/dynamic-rows-import-custom-options-per-page": "Vnecoms_VendorsProduct/js/components/dynamic-rows-import-custom-options-per-page"
    }
};
