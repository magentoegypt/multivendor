					...
					if(isset($data['setting']['removeimg']) && count($data['setting']['removeimg'])>0){
						foreach($data['setting']['removeimg'] as $imageName){
							...
							if(isset($data['setting']['addimg']) && count($data['setting']['addimg'])>0){
								$key = array_search ($imageName, array_combine(range(1, count($data['setting']['addimg'])), array_values($data['setting']['addimg'])));
								if($key){
							...
							if(isset($data['setting']['url']) && count($data['setting']['url'])>0){
								$keyUrl = array_search ($imageName, array_combine(range(1, count($data['setting']['url'])), array_values($data['setting']['url'])));
								if($keyUrl){
