...
define(["jquery", "knockout", "Magento_PageBuilder/js/events", "Vnecoms_VendorsPageBuilder/js/utils/check-stage-full-screen", "Vnecoms_VendorsPageBuilder/js/utils/pagebuilder-header-height", "Vnecoms_VendorsPageBuilder/js/utils/promise-deferred"], function (_jquery, _knockout, _events, _checkStageFullScreen, _pagebuilderHeaderHeight, _promiseDeferred) {
  /**
  ...
  var Toolbar = /*#__PURE__*/function () {
    ...
    _createClass(Toolbar, [{
      key: "template",
      get: function get() {
        return "Vnecoms_VendorsPageBuilder/content-type-toolbar";
      }
    }]);
