...
class Data extends AbstractHelper
{
     ...
     * @var
     */
    protected $_ignoreUpdateApprovalProductAttributes;

    /**
     * @var array
     */
    protected $_ignoreRestrictionProductAttributes;

    /**
     * @var array
     */
    protected $_additionElasticAttribute;

    /**
     * Data constructor.
     * @param \Magento\Framework\App\Helper\Context $context
     * @param \Vnecoms\Vendors\Helper\Email $emailHelper
     * @param array $notAllowedProductAttributes
     * @param array $joinProductAttribute
     * @param array $ignoreUpdateApprovalProductAttributes
     * @param array $ignoreRestrictionProductAttributes
     * @param array $additionElasticAttribute
     */
    public function __construct(
        ...
        array $ignoreUpdateApprovalProductAttributes = [],
        array $ignoreRestrictionProductAttributes = [],
        array $additionElasticAttribute = []
    ) {
        ...
        $this->_ignoreUpdateApprovalProductAttributes = $ignoreUpdateApprovalProductAttributes;
        $this->_ignoreRestrictionProductAttributes = $ignoreRestrictionProductAttributes;
        $this->_additionElasticAttribute = $additionElasticAttribute;
    }
     ...
     * @return array
     */
    public function getAdditionElasticAttribute()
    {
        return $this->_additionElasticAttribute;
    }
     ...
     * @return array
     */
    public function getIgnoreUpdateApprovalProductAttributes()
    {
        return $this->_ignoreUpdateApprovalProductAttributes;
    }
     ...
     * @return array
     */
    public function getIgnoreRestrictionProductAttributes()
    {
        return $this->_ignoreRestrictionProductAttributes;
    }
    ...
    {
        $attributes = $this->scopeConfig->getValue(self::XML_CATALOG_UPDATE_ATTRIBUTE_APPROVAL);
    ...
    {
        if ($this->scopeConfig->getValue(self::XML_CATALOG_PRODUCT_TYPE_RESTRICTION)) {
    ...
    {
        if ($this->scopeConfig->getValue(self::XML_CATALOG_ATTRIBUTE_SET_RESTRICTION)) {
