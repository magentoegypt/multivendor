...
class Product implements \Magento\Ui\Model\UrlInput\ConfigInterface
{
    ...
    public function getConfig(): array
    {
        return [
            'label' => __('Product'),
            'component' => 'Vnecoms_VendorsPageBuilder/js/components/product-ui-select',
            'disableLabel' => true,
            'filterOptions' => true,
            'searchOptions' => true,
            'chipsEnabled' => true,
            ...
            'searchUrl' => $this->urlBuilder->getUrl('pagebuilder/product/search'),
            ...
            'validationUrl' => $this->urlBuilder->getUrl('pagebuilder/product/getSelected'),
        ];
    }
}
