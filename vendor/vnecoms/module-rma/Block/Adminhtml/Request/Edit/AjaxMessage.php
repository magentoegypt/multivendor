 ...
 */
class AjaxMessage extends \Magento\Backend\Block\Template
{
    ...
    {
        if (!$this->_requestRma) {
            $this->_requestRma = $this->_coreRegistry->registry("current_ticket");
        }
        return $this->_requestRma;
    }

    /**
     * set Curent Request Data
     * @return mixed
     */
    public function setRma($request)
    {
        $this->_requestRma = $request;
        return $this;
    }
    /**
