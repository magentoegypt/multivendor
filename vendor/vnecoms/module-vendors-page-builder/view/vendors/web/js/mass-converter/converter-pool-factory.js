...
define(["Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/utils/loader", "Vnecoms_VendorsPageBuilder/js/mass-converter/converter-pool"], function (_config, _loader, _converterPool) {
  /**
