/*eslint-disable */
/* jscs:disable */
define(["html2canvas", "jquery", "mage/translate", "Vnecoms_VendorsPageBuilder/js/modal/confirm-alert", "Vnecoms_VendorsPageBuilder/js/modal/template-manager-save", "text!Vnecoms_VendorsPageBuilder/template/modal/template-manager/save-content-modal.html", "uiRegistry", "underscore", "Vnecoms_VendorsPageBuilder/js/acl", "Vnecoms_VendorsPageBuilder/js/config"], function (_html2canvas, _jquery, _translate, _confirmAlert, _templateManagerSave, _saveContentModal, _uiRegistry, _underscore, _acl, _config) {
  /**
