...
namespace Vnecoms\VendorsPageBuilder\Model\Catalog;
...
class ProductTotals
{
     ...
     * @param \Vnecoms\VendorsProduct\Helper\Data $helperData
     */
    public function __construct(
        ...
        \Vnecoms\VendorsProduct\Helper\Data $helperData
    ) {
    ...
    private function getProductCollection(string $conditions, bool $usePriceIndex = true): Collection
    {
        ...
        $collection->addAttributeToFilter("vendor_id", $this->vendorSession->getVendor()->getId());
        $collection->addAttributeToFilter('approval', ['in' => $this->helperData->getAllowedApprovalStatus()]);
