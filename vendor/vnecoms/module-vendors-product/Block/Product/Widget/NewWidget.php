 ...
 * New products widget
 */
class NewWidget extends \Vnecoms\VendorsProduct\Block\Product\NewProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    {
        $object_manager = \Magento\Framework\App\ObjectManager::getInstance();
        $serialize = $object_manager->get('\Magento\Framework\Serialize\Serializer\Serialize');
        ...
        return array_merge(
            ...
            [
                ...
                $serialize->serialize($this->getRequest()->getParams())
            ]
        );
    }
