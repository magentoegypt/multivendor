define([], function () {
    return {
        ...
        getCategoriesHtml: function(item, components, html) {
            ...
            return highlight
                //  Hub Market: upstream hard-codes the English word "in" here, so
                //  Arabic showed "in نسائي". hmIn is added to algoliaConfig.translations
                //  server-side by MagentoEgypt_AlgoliaVendor's
                //  AddStorefrontTranslations observer. This line is the ONLY change
                //  from algoliasearch-magento-2 3.18.1 — re-diff on upgrade.
                ? html`<span>${algoliaConfig.translations.hmIn || 'in'} ${highlight}</span>`
                : "";
        },
