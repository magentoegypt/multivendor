...
class History extends Extended
{
    ...
    {
        parent::_construct();
        $this->setId('venndor_customer_rma');
    ...
    {
        $vendorId = $this->_coreRegistry->registry('vendor_id');
        ...
        $collection->addAttributeToFilter("entity_id",array("neq"=>$this->getRequestRma()->getId()));
