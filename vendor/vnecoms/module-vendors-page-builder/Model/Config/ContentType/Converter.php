...
{
    const DEFAULT_ATTRIBUTE_READER = 'Vnecoms_VendorsPageBuilder/js/property/attribute-reader';
    const DEFAULT_PROPERTY_READER = 'Vnecoms_VendorsPageBuilder/js/property/style-property-reader';
