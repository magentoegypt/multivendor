 ...
 */
namespace MagentoEgypt\VendorExtend\Model\CreditProcessor;
...
class RefundItemCommission extends \Vnecoms\Credit\Model\Processor\AbstractProcessor
{
    ...
    public function process($data = [])
    {
        ...
        $transData = [
            ...
            'vendor_description' => json_encode([$data['order']->getIncrementId(),$data['creditmemo_item']->getName(),$data['creditmemo_item']->getQty()*1]),
