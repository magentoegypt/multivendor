...
namespace Vnecoms\VendorsCategory\Test\Unit\Model\Category;

class TreeTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject | \Vnecoms\VendorsCategory\Model\ResourceModel\Category\Tree
     */
    protected $categoryTreeMock;

    /**
     * @var \PHPUnit_Framework_MockObject_MockObject | \Vnecoms\VendorsCategory\Model\ResourceModel\Category\Collection
     */
    protected $categoryCollection;

    /**
     * @var \PHPUnit_Framework_MockObject_MockObject | \Vnecoms\VendorsCategory\Api\Data\CategoryTreeInterfaceFactory
     */
    ...
    protected function setUp()
    {
        ...
        $this->categoryTreeMock = $this->getMockBuilder(
            '\Vnecoms\VendorsCategory\Model\ResourceModel\Category\Tree'
        )->disableOriginalConstructor()
            ->getMock();

        $this->categoryCollection = $this->getMockBuilder(
            '\Vnecoms\VendorsCategory\Model\ResourceModel\Category\Collection'
        )->disableOriginalConstructor()
            ->getMock();

        $methods = ['create'];
        $this->treeFactoryMock =
            $this->getMock('\Vnecoms\VendorsCategory\Api\Data\CategoryTreeInterfaceFactory', $methods, [], '', false);

        $this->tree = $this->objectManager
            ->getObject(
                'Vnecoms\VendorsCategory\Model\Category\Tree',
                [
    ...
    public function testGetTree()
    {
        ...
        $treeNodeMock1 = $this->getMock('\Vnecoms\VendorsCategory\Api\Data\CategoryTreeInterface');
        ...
        $treeNodeMock2 = $this->getMock('\Vnecoms\VendorsCategory\Api\Data\CategoryTreeInterface');
    ...
    {
        $currentLevel = 1;
        $treeNodeMock = $this->getMock('\Vnecoms\VendorsCategory\Api\Data\CategoryTreeInterface');
