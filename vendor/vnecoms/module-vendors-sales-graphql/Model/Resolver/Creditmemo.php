...
use Vnecoms\VendorsSalesGraphQl\Model\Creditmemo\GetListCreditMemo;
use Magento\Framework\GraphQl\Exception\GraphQlAuthorizationException;

/**
 * Products field resolver, used for GraphQL request processing.
 */
class Creditmemo implements ResolverInterface
{
    /**
     * @var GetListCreditMemo
     */
    private $getListCreditMemo;

    /**
     * Creditmemo constructor.
     * @param GetListCreditMemo $getListCreditMemo
     */
    public function __construct(
        GetListCreditMemo $getListCreditMemo
    ) {
        $this->getListCreditMemo = $getListCreditMemo;
    }
    ...
    public function resolve(
        ...
        $searchResult = $this->getListCreditMemo->execute($args, $info, $context);
