...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "underscore", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/drag-drop/move-content-type", "Vnecoms_VendorsPageBuilder/js/drag-drop/registry", "Vnecoms_VendorsPageBuilder/js/drag-drop/sortable", "Vnecoms_VendorsPageBuilder/js/utils/check-stage-full-screen", "Vnecoms_VendorsPageBuilder/js/utils/create-stylesheet", "Vnecoms_VendorsPageBuilder/js/utils/pagebuilder-header-height", "Vnecoms_VendorsPageBuilder/js/content-type/column/resize", "Vnecoms_VendorsPageBuilder/js/content-type/preview-collection", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/drag-and-drop", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/factory", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/grid-size", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/registry"], function (_jquery, _knockout, _translate, _events, _underscore, _config, _moveContentType, _registry, _sortable, _checkStageFullScreen, _createStylesheet, _pagebuilderHeaderHeight, _resize, _previewCollection, _dragAndDrop, _factory, _gridSize, _registry2) {
