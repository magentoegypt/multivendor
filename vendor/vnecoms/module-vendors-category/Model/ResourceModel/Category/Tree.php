...
class Tree extends Dbp
{
    ...
    /**
     * @var \Vnecoms\VendorsCategory\Model\ResourceModel\Category\Collection\Factory
     */
    ...
    public function __construct(
        \Vnecoms\VendorsCategory\Model\ResourceModel\Category $catalogCategory,
        ...
        parent::__construct(
            $resource->getConnection('vendorscategory'),
            $resource->getTableName('ves_vendorscategory_category'),
            [
    ...
    protected function _initInactiveCategoryIds()
    {
        ...
        $this->_eventManager->dispatch('vendor_category_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    protected function _getDisabledIds($collection, $allIds)
    {
        ...
        $this->_inactiveItems = array_merge($this->_getInactiveItemIds($collection), $this->_inactiveItems);
    ...
    {
        $this->_cache->clean([\Vnecoms\VendorsCategory\Model\Category::CACHE_TAG]);
