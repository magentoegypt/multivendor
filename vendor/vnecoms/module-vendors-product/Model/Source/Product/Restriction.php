...
class Restriction extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    ...
    public function getAllOptions()
    {
        if ($this->_options === null) {
            foreach ($this->attrCollection as $attr) {
                if (in_array( $attr->getAttributeCode(), $this->productHelper->getIgnoreRestrictionProductAttributes()))
                    continue;
