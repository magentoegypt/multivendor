...
use Vnecoms\VendorsCreditGraphQl\Model\Credit\GetListTransaction;
use Magento\Framework\GraphQl\Exception\GraphQlAuthorizationException;

/**
 * Products field resolver, used for GraphQL request processing.
 */
class Transactions implements ResolverInterface
{
    /**
     * @var GetListTransaction
     */
    private $getListTransaction;

    /**
     * Transactions constructor.
     * @param GetListTransaction $getListTransaction
     */
    public function __construct(
        GetListTransaction $getListTransaction
    ) {
        $this->getListTransaction = $getListTransaction;
    }
    ...
    public function resolve(
        ...
        $searchResult = $this->getListTransaction->execute($args, $info, $context);
