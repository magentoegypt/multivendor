define([
    ...
    return Element.extend({
		...
		getCommissionTextHtml: function () {
			return $t('This commission will be paid for marketplace website when this product is sold.')
				+ "<br/>" + $t('The amount may be a bit different based on the qty of item and customer address.');
		},
