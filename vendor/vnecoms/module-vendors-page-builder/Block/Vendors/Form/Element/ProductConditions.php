...
namespace Vnecoms\VendorsPageBuilder\Block\Vendors\Form\Element;
...
class ProductConditions extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Vnecoms_VendorsPageBuilder::form/element/conditions.phtml';
    ...
    public function getConfigJson(): string
    {
        return $this->serializer->serialize([
            '[data-role=pagebuilder-conditions-form-placeholder-' . $this->getData('attribute') . ']' => [
                'Vnecoms_VendorsPageBuilder/js/form/element/conditions-loader' => $this->getConfig(),
            ]
        ]);
    }
}
