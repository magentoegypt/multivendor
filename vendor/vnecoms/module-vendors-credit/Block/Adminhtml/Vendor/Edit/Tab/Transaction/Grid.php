    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'type' => 'text',
                'index' => 'description',
                'renderer' => 'Vnecoms\VendorsCredit\Block\Adminhtml\Vendor\Edit\Tab\Transaction\Description',
            ]
        );
        ...
        $this->addExportType('*/credit_transactions/exportCsv', __('CSV'));
        $this->addExportType('*/credit_transactions/exportXml', __('XML'));
