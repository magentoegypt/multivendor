 ...
 */
namespace Vnecoms\VendorsCms\Block\Widget\Page;

/**
 * Widget to display link to CMS page
 */
class Link extends \Magento\Cms\Block\Widget\Page\Link implements \Magento\Widget\Block\BlockInterface
{
    /**
     ...
     * @param \Magento\Cms\Model\ResourceModel\Page $cmsResourcePage
     * @param \Magento\Cms\Helper\Page $cmsCorePage
     * @param \Vnecoms\VendorsCms\Model\ResourceModel\Page $resourcePage
     * @param \Vnecoms\VendorsCms\Helper\Page $cmsPage
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Magento\Cms\Model\ResourceModel\Page $cmsResourcePage,
        \Magento\Cms\Helper\Page $cmsCorePage,
        \Vnecoms\VendorsCms\Model\ResourceModel\Page $resourcePage,
        \Vnecoms\VendorsCms\Helper\Page $cmsPage,
        array $data = []
    ) {
        parent::__construct($context,$cmsResourcePage , $cmsCorePage , $data);
    ...
    public function getHref()
    {
        ...
        if ($this->getData('type_page') != "vendor_page") return parent::getHref();
    ...
    {
        if ($this->getData('type_page') != "vendor_page") return parent::getTitle();
        if (!$this->_title) {
            $this->_title = '';
    ...
    {
        if ($this->getData('type_page') != "vendor_page") return parent::getLabel();
