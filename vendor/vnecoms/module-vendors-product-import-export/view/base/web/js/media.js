...
define([
    ...
    return Component.extend({
        defaults: {
            fileInput: '',
            availablePageSize: [10, 20, 50, 100],
            images: {},
            enableLog: false,
            maxFileSize: false,
...
return; }
        ...
        viewImage: function (image) {
            $('<div class="thumbnail-preview import-view-image"></div>').html('<div class="thumbnail-preview-image-block"><img class="thumbnail-preview-image" src="'+image.url+'" /></div>')
            .modal({
                title: image.name,
                type: 'popup',
