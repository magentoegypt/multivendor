...
class AdminAddCredit extends \Vnecoms\Credit\Model\Processor\AbstractProcessor
{
    ...
    public function process($data = [])
    {
        ...
        $transData = [
            ...
            'vendor_description' => json_encode([$this->_creditAccount->formatBaseCurrency($data['amount'])]),
