...
define(["underscore", "Vnecoms_VendorsPageBuilder/js/utils/object", "Vnecoms_VendorsPageBuilder/js/content-type/appearance-config"], function (_underscore, _object, _appearanceConfig) {
  /**
