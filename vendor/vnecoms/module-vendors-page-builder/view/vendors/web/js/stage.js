/*eslint-disable */
/* jscs:disable */
define(["jquery", "knockout", "Magento_PageBuilder/js/events", "Vnecoms_VendorsPageBuilder/js/resource/jquery/ui/jquery.ui.touch-punch", "mageUtils", "underscore", "Vnecoms_VendorsPageBuilder/js/binding/sortable", "Vnecoms_VendorsPageBuilder/js/collection", "Vnecoms_VendorsPageBuilder/js/data-store", "Vnecoms_VendorsPageBuilder/js/drag-drop/matrix", "Vnecoms_VendorsPageBuilder/js/master-format/render", "Vnecoms_VendorsPageBuilder/js/stage-builder", "Vnecoms_VendorsPageBuilder/js/utils/editor", "Vnecoms_VendorsPageBuilder/js/utils/promise-deferred"], function (_jquery, _knockout, _events, _jqueryUi, _mageUtils, _underscore, _sortable, _collection, _dataStore, _matrix, _render, _stageBuilder, _editor, _promiseDeferred) {
  /**
  ...
  var Stage = /*#__PURE__*/function () {
    ...
    function Stage(pageBuilder, rootContainer) {
      ...
      this.renderingLocks = [];
      this.template = "Vnecoms_VendorsPageBuilder/content-type/preview";
