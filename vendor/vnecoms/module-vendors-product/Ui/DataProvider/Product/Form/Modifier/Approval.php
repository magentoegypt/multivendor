...
class Approval extends AbstractModifier
{
    ...
    public function modifyData(array $data)
    {
        ...
        $updateData = $this->serializer->unserialize($updateCollection->getFirstItem()->getProductData());
    ...
    public function modifyMeta(array $meta)
    {
        ...
        if ($updateCollection->count()) {
            $data = $this->serializer->unserialize($updateCollection->getFirstItem()->getProductData());
