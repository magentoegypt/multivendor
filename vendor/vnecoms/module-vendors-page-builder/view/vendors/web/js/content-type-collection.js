...
define(["Magento_PageBuilder/js/events", "underscore", "Vnecoms_VendorsPageBuilder/js/collection", "Vnecoms_VendorsPageBuilder/js/content-type"], function (_events, _underscore, _collection, _contentType) {
  /**
