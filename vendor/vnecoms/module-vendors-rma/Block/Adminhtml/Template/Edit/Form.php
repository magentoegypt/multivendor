 ...
 */
namespace Vnecoms\VendorsRMA\Block\Adminhtml\Template\Edit;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class'=>'admin__control-select',
                'label' => __('Use Custom Message'),
                'required' => true,
                'values' => $options,
                'note'=> __("If yes then please add command <strong>{{var custom_message}}</strong> into Template Content")
            ]
        );
        ...
        $fieldset->addField(
            'variables',
            'hidden',
            ['name' => 'variables', 'value' => \Laminas\Json\Json::encode($this->getVariables())]
        );
