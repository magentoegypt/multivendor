...
//         $rate = $this->calculationTool->getRate($taxRateRequest);
        ...
        $maxAmount = $address->getBaseSubtotalWithDiscount() + $address->getBaseShippingAmount() + $address->getBaseTaxAmount();
        $maxAmount = $maxAmount < 0 ? 0 : $maxAmount;
        if ($quote->getData('base_credit_amount')) {
        ...
        $this->applyCreditToItems($usedCredit, $baseUsedCredit, $calculatedCreditItems);
