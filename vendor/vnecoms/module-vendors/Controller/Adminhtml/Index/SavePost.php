...
class SavePost extends Action implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        if ($originalRequestData) {
            try {
                ...
                $storeId = $this->_objectManager->get('Magento\Store\Model\StoreManagerInterface')
                    ->getWebsite($originalRequestData["website_id"])
                    ->getDefaultStore()
                    ->getId();
