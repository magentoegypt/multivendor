...
namespace Vnecoms\VendorsPageBuilder\Model\Stage;
...
class Config
{
    const DEFAULT_PREVIEW_COMPONENT = 'Vnecoms_VendorsPageBuilder/js/content-type/preview';
    const DEFAULT_MASTER_COMPONENT = 'Vnecoms_VendorsPageBuilder/js/content-type/master';
    ...
    const TEMPLATE_DELETE_RESOURCE = 'Vnecoms_VendorsPageBuilder::template_delete';
    const TEMPLATE_SAVE_RESOURCE = 'Vnecoms_VendorsPageBuilder::template_save';
    const TEMPLATE_APPLY_RESOURCE = 'Vnecoms_VendorsPageBuilder::template_apply';

    const CONTENT_TYPE_CACHE_ID = 'VNECOMS_CONTENT_TYPE';
    const TINY_MCE_CONFIG_CACHE_ID = 'VNECOMS_TINY_MCE_CONFIG';
    const WIDGET_BREAKPOINTS_CACHE_ID = 'VNECOMS_WIDGET_BREAKPOINS';
     ...
     * @param \Magento\PageBuilder\Model\Stage\Config\UiComponentConfig $uiComponentConfig
    ...
    public function __construct(
        ...
        \Magento\PageBuilder\Model\Stage\Config\UiComponentConfig $uiComponentConfig,
        ...
        \Vnecoms\VendorsPageBuilder\Model\WidgetInitializerConfig $widgetInitializerConfig,
