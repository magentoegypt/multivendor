...
], function ($, mage, $t, modal, alert, customerData) {
    'use strict';
    ...
    $.widget('mage.customerLoginValidate', {
        ...
        initOtpForm: function(){
            var options = {
                ...
                responsive: true,
                innerScroll: true,
                title: $.mage.__('Otp Verification'),
                buttons: []
            };
        ...
        initValidation: function(){
            ...
            this.element.validation({
                ...
                submitHandler: function (form) {
                    ...
                    if(form.login_type.value == 'by_mobile')
                    {
                        formData.append('type', form.login_type.value.replace('by_', ''));
        ...
        verifyOtp: function(){
            ...
            $.ajax({
                ...
                if(response.success){
                    customerData.reload(['wishlist','customer'], true);
                    setTimeout(function() {
