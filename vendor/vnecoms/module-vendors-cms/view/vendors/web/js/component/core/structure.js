...
define(['vendorscms/hook', 'jquery', 'jquery/ui', 'vendorscms/renderer', 'vendorscms/dragdrop', 'bluefoot/config', 'bluefoot/modal', 'bluefoot/edit'], function (Hook, jQuery, jQueryUi, Render, DragDropClass, Config, Modal, EditClass) {
    ...
    Structural.prototype.equalColumnHeights = function ($hook) {
        ...
        if (columns.length) {
            ...
            for (var key in columnByOffset) {
                if (!columnByOffset.hasOwnProperty(key)) {
continue; }
