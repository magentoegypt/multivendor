/*eslint-disable */
/* jscs:disable */
define(["Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/utils/directives", "Vnecoms_VendorsPageBuilder/js/utils/url"], function (_config, _directives, _url) {
  /**
