...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "Vnecoms_VendorsPageBuilder/js/modal/dismissible-confirm", "underscore", "Vnecoms_VendorsPageBuilder/js/binding/live-edit", "Vnecoms_VendorsPageBuilder/js/binding/sortable", "Vnecoms_VendorsPageBuilder/js/binding/sortable-children", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-collection", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type-menu", "Vnecoms_VendorsPageBuilder/js/content-type-menu/edit", "Vnecoms_VendorsPageBuilder/js/content-type-menu/option", "Vnecoms_VendorsPageBuilder/js/content-type-menu/title-option", "Vnecoms_VendorsPageBuilder/js/drag-drop/registry", "Vnecoms_VendorsPageBuilder/js/drag-drop/sortable", "Vnecoms_VendorsPageBuilder/js/utils/check-stage-full-screen", "Vnecoms_VendorsPageBuilder/js/utils/object", "Vnecoms_VendorsPageBuilder/js/content-type/appearance-config"], function (_jquery, _knockout, _translate, _events, _dismissibleConfirm, _underscore, _liveEdit, _sortable, _sortableChildren, _config, _contentTypeCollection, _contentTypeFactory, _contentTypeMenu, _edit, _option, _titleOption, _registry, _sortable2, _checkStageFullScreen, _object, _appearanceConfig) {
  /**
    ...
    _proto.retrieveOptions = function retrieveOptions() {
      var options = {
        ...
        title: new _titleOption({
          ...
          template: "Vnecoms_VendorsPageBuilder/content-type/title",
          sort: 20
        }),
        edit: new _option({
          preview: this,
