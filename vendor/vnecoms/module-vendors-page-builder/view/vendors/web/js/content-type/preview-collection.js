...
define(["Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type/preview"], function (_config, _contentTypeFactory, _preview) {
  /**
  ...
  var PreviewCollection = /*#__PURE__*/function (_preview2) {
    ...
    _createClass(PreviewCollection, [{
       ...
       */
      function get() {
        return "Vnecoms_VendorsPageBuilder/content-type/preview-collection";
      }
    }]);
