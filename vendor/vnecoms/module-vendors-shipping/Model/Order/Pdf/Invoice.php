 ...
 */
namespace Vnecoms\VendorsShipping\Model\Order\Pdf;
...
class Invoice extends \Magento\Sales\Model\Order\Pdf\Invoice
{
     ...
     * @param \Vnecoms\VendorsSales\Model\ResourceModel\Order\Invoice\CollectionFactory $vendorInvoice
    ...
    public function getPdf($invoices = [])
    {
        ...
        foreach ($invoices as $invoice) {
            ...
            $vendorOrders = $this->getVendorOrders($invoice);

            /* Add head */
            $this->insertVendorOrder(
                $page,
                $order,
                $vendorOrders,
     ...
     * @return array
     */
    public function getVendorOrders($invoice)
    {
        $vendorOrders = [];
     ...
     */
    protected function insertVendorOrder(&$page, $obj,$vendorOrders, $putOrderId = true)
    {
        ...
        if ($order->getIsVirtual()) {
            ...
            foreach ($vendorOrders as $vendorOrder) {
                ...
                $shippingMethod = $vendor->getVendorId().": ".$vendorOrder->getShippingDescription();
                ...
                $totalShippingChargesText = "("
                    . __('Shipping Charges')
                    . " "
                    . $order->formatPriceTxt($vendorOrder->getShippingAmount())
                    . ")";
