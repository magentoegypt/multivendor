 ...
 */
namespace Vnecoms\VendorsRMA\Block\Adminhtml\Template;
...
class Edit extends Widget implements ContainerInterface
{
    ...
    protected function _prepareLayout()
    {
        ...
        $this->addChild('form', 'Vnecoms\VendorsRMA\Block\Adminhtml\Template\Edit\Form');
    ...
    {
        return $this->getUrl('vrma/*/save', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('vrma/*/preview');
    }
    ...
    {
        return $this->getUrl('vrma/*/delete', ['_current' => true]);
    }
    ...
    {
        return $this->getUrl('vrma/*/defaultTemplate');
    }
