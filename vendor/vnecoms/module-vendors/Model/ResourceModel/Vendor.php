...
class Vendor extends \Magento\Eav\Model\Entity\AbstractEntity
{
    ...
    protected function _setCustomerData(
        ...
        $object->setData('customer_account',$customer->getId());
        $object->setData('website_id',$customer->getData('website_id'));
        return $this;
    }
    ...
    public function loadByCustomer(
        ...
        if($vendorId){
            ...
            if($object->getEntityId()) $this->_setCustomerData($object, $customer, false);
        }
    }
