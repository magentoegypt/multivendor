 ...
 */
namespace Vnecoms\VendorsProductDownloadable\Ui\DataProvider\Product\Form\Modifier;
...
class Links extends AbstractModifier
{
    ...
    protected function getFileColumn()
    {
        ...
        $fileTypeField['arguments']['data']['config'] = [
            ...
            'componentType' => Form\Field::NAME,
            'component' => 'Vnecoms_VendorsProductDownloadable/js/components/upload-type-handler',
            'dataType' => Form\Element\DataType\Text::NAME,
            'dataScope' => 'type',
        ...
        $fileUploader['arguments']['data']['config'] = [
            ...
            'component' => 'Vnecoms_VendorsProductDownloadable/js/components/file-uploader',
            'elementTmpl' => 'Vnecoms_VendorsProductDownloadable/components/file-uploader',
            'fileInputName' => 'links',
            'uploaderConfig' => [
