/*eslint-disable */
/* jscs:disable */
define(["consoleLogger", "jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "underscore", "Vnecoms_VendorsPageBuilder/js/binding/draggable", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/drag-drop/drop-indicators", "Vnecoms_VendorsPageBuilder/js/drag-drop/registry", "Vnecoms_VendorsPageBuilder/js/panel/menu", "Vnecoms_VendorsPageBuilder/js/panel/menu/content-type", "Vnecoms_VendorsPageBuilder/js/utils/position-sticky"], function (_consoleLogger, _jquery, _knockout, _translate, _events, _underscore, _draggable, _config, _dropIndicators, _registry, _menu, _contentType, _positionSticky) {
  /**
  ...
  var Panel = /*#__PURE__*/function () {
    ...
    function Panel(pageBuilder) {
      ...
      this.template = "Vnecoms_VendorsPageBuilder/panel";
