...
define(["jquery", "knockout", "mage/translate", "Magento_PageBuilder/js/events", "Magento_Ui/js/modal/alert", "Vnecoms_VendorsPageBuilder/js/config", "Vnecoms_VendorsPageBuilder/js/content-type-factory", "Vnecoms_VendorsPageBuilder/js/content-type-menu/option", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/grid-size", "Vnecoms_VendorsPageBuilder/js/content-type/column-group/preview", "Vnecoms_VendorsPageBuilder/js/content-type/preview-collection", "Vnecoms_VendorsPageBuilder/js/content-type/column/resize"], function (_jquery, _knockout, _translate, _events, _alert, _config, _contentTypeFactory, _option, _gridSize, _preview, _previewCollection, _resize) {
  /**
